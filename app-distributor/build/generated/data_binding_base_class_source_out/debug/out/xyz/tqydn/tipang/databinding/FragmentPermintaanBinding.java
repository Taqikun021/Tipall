...
public final class FragmentPermintaanBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentPermintaanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPermintaanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_permintaan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPermintaanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPermintaanBinding((FrameLayout) rootView, iv, kosong, loading, refresh, rv,
          tv);
    }
