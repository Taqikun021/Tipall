...
public final class ActivityDetailTawaranBinding implements ViewBinding {
  ...
  private ActivityDetailTawaranBinding(@NonNull NestedScrollView rootView,
  ...
  public static ActivityDetailTawaranBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDetailTawaranBinding((NestedScrollView) rootView, HargaBarang, LayoutMap,
          alamat, barang, cardBarang, cl, counter, descBarang, imagePenjual, jarak, judul, jumlah,
          kodeTransaksi, kurang, layoutBarang, layoutBintang, linearLayout, namaBarang, namaPemilik,
          namaUsaha, ratingPenjual, tambah, tanggal, total, transaksi, tv, tv1, view, view1, view2,
          view3, view4);
    }
