...
public final class RowTawaranBinding implements ViewBinding {
  ...
  private RowTawaranBinding(@NonNull CardView rootView, @NonNull TextView HargaBarang,
      @NonNull CardView cv, @NonNull ImageView imageBarang, @NonNull ImageView imagePenjual,
      @NonNull TextView jarak, @NonNull LinearLayout linearLayout, @NonNull TextView namaBarang,
      @NonNull TextView namaUsaha, @NonNull TextView stok) {
  ...
  public static RowTawaranBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowTawaranBinding((CardView) rootView, HargaBarang, cv, imageBarang, imagePenjual,
          jarak, linearLayout, namaBarang, namaUsaha, stok);
    }
