...
public final class ActivityTambahUsahaBinding implements ViewBinding {
  ...
  private ActivityTambahUsahaBinding(@NonNull CoordinatorLayout rootView,
  ...
  public static ActivityTambahUsahaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTambahUsahaBinding((CoordinatorLayout) rootView, LayoutLokasi, LayoutNama,
