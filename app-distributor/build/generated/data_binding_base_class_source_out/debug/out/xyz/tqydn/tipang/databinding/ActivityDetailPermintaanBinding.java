...
public final class ActivityDetailPermintaanBinding implements ViewBinding {
  ...
  private ActivityDetailPermintaanBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull ConstraintLayout layoutBarang, @NonNull LinearLayout linearLayout,
      @NonNull ConstraintLayout linearLayout2, @NonNull LinearLayout ll,
      @NonNull TextView namaBarang, @NonNull TextView namaPemilik, @NonNull TextView namaUsaha,
      @NonNull TextView nomorHP, @NonNull TextView ratingPenjual, @NonNull TextView tanggal,
      @NonNull Button terima, @NonNull Button tolak, @NonNull TextView totalHarga,
      @NonNull TextView tv, @NonNull TextView tv2, @NonNull View view3) {
  ...
  public static ActivityDetailPermintaanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDetailPermintaanBinding((NestedScrollView) rootView, alamat, barang,
