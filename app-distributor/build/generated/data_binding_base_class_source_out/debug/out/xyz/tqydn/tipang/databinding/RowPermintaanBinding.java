...
public final class RowPermintaanBinding implements ViewBinding {
  ...
  private RowPermintaanBinding(@NonNull CardView rootView, @NonNull CardView cardTawaran,
  ...
  public static RowPermintaanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowPermintaanBinding((CardView) rootView, cardTawaran, carddesc, imageBarang,
