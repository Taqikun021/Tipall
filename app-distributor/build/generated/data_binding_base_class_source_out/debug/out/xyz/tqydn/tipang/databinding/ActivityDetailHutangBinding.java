...
public final class ActivityDetailHutangBinding implements ViewBinding {
  ...
  private ActivityDetailHutangBinding(@NonNull NestedScrollView rootView, @NonNull TextView alamat,
      ...
      @NonNull Button tandaiLunas, @NonNull TextView tanggal, @NonNull TextView totalHarga,
      @NonNull TextView tv2, @NonNull View view3) {
  ...
  public static ActivityDetailHutangBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDetailHutangBinding((NestedScrollView) rootView, alamat, barang,
          ...
          namaUsaha, nomorHP, ratingPenjual, tandaiLunas, tanggal, totalHarga, tv2, view3);
    }
