...
public final class ActivityEditUsahaBinding implements ViewBinding {
  ...
  private ActivityEditUsahaBinding(@NonNull CoordinatorLayout rootView,
  ...
  public static ActivityEditUsahaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditUsahaBinding((CoordinatorLayout) rootView, LayoutLokasi, LayoutNama,
