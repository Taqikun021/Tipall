...
public final class ActivityRiwayatTransaksiBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final Button buatTransaksi;
  ...
  private ActivityRiwayatTransaksiBinding(@NonNull NestedScrollView rootView,
      @NonNull TextView alamat, @NonNull ImageView barang, @NonNull Button buatTransaksi,
      ...
      @NonNull TextView status, @NonNull TextView tanggal, @NonNull TextView totalHarga,
  ...
  @NonNull
  public static ActivityRiwayatTransaksiBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRiwayatTransaksiBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_riwayat_transaksi, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRiwayatTransaksiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.buatTransaksi;
      Button buatTransaksi = rootView.findViewById(id);
      if (buatTransaksi == null) {
        break missingId;
      }
      ...
      return new ActivityRiwayatTransaksiBinding((NestedScrollView) rootView, alamat, barang,
          buatTransaksi, cardBarang, descBarang, imagePenjual, imageUsaha, judul, jumlahBarang,
          kodeTransaksi, layoutBarang, linearLayout, ll, namaBarang, namaPemilik, namaUsaha,
          ratingPenjual, status, tanggal, totalHarga, tv2, view3);
    }
