...
public final class RowPermintaanBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final CardView cardPermintaan;
  ...
  private RowPermintaanBinding(@NonNull CardView rootView, @NonNull TextView HargaBarang,
      @NonNull CardView cardPermintaan, @NonNull CardView cv, @NonNull ImageView imageBarang,
      @NonNull ImageView imagePenjual, @NonNull TextView jarak, @NonNull LinearLayout linearLayout,
      @NonNull TextView namaBarang, @NonNull TextView namaUsaha, @NonNull TextView stok) {
    this.rootView = rootView;
    this.HargaBarang = HargaBarang;
    this.cardPermintaan = cardPermintaan;
    this.cv = cv;
  ...
  @NonNull
  public static RowPermintaanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowPermintaanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_permintaan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowPermintaanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CardView cardPermintaan = (CardView) rootView;
      ...
      return new RowPermintaanBinding((CardView) rootView, HargaBarang, cardPermintaan, cv,
          imageBarang, imagePenjual, jarak, linearLayout, namaBarang, namaUsaha, stok);
    }
