...
public final class FragmentBarangBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentBarangBinding(@NonNull FrameLayout rootView, @NonNull ImageView iv,
      @NonNull ConstraintLayout kosong, @NonNull CircularProgressIndicator loading,
      @NonNull SwipeRefreshLayout refresh, @NonNull RecyclerView rvBarang,
  ...
  @NonNull
  public static FragmentBarangBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentBarangBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_barang, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentBarangBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBarangBinding((FrameLayout) rootView, iv, kosong, loading, refresh,
          rvBarang, toolbar, tv);
    }
