...
public final class ActivityDetailTawaranBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityDetailTawaranBinding(@NonNull NestedScrollView rootView, @NonNull TextView alamat,
      ...
      @NonNull TextView tanggal, @NonNull Button terima, @NonNull Button tolak,
      @NonNull TextView totalHarga, @NonNull TextView tv, @NonNull TextView tv2,
      @NonNull View view3) {
  ...
  @NonNull
  public static ActivityDetailTawaranBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDetailTawaranBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_detail_tawaran, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDetailTawaranBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tolak;
      Button tolak = rootView.findViewById(id);
      if (tolak == null) {
        break missingId;
      }
      ...
      return new ActivityDetailTawaranBinding((NestedScrollView) rootView, alamat, barang,
          ...
          namaUsaha, nomorHP, ratingPenjual, tanggal, terima, tolak, totalHarga, tv, tv2, view3);
    }
